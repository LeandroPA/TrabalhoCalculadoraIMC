...
public class  IMC {
	...
	public static String BAIXO_PESO = "Baixo peso";
	public static String PESO_NORMAL = "Peso normal";
	public static String SOBREPESO = "Sobrepeso";
	public static String OBESIDADE = "Obesidade";
	public static String OBESIDADE_GRAU_I = "Obesidade grau I";
